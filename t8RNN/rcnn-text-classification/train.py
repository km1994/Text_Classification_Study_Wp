...
# Data loading params
tf.flags.DEFINE_string("pos_dir", "F:/document/datasets/nlpData/sentiment_analysis_dataset/Movie_Review-polaritydata/rt-polaritydata/rt-polarity.pos.txt", "Path of positive data")
tf.flags.DEFINE_string("neg_dir", "F:/document/datasets/nlpData/sentiment_analysis_dataset/Movie_Review-polaritydata/rt-polaritydata/rt-polarity.neg.txt", "Path of negative data")
...
tf.flags.DEFINE_string("word2vec", "F:/document/datasets/nlpData/word_embedding/Google_Word2vec/GoogleNews-vectors-negative300.bin/GoogleNews-vectors-negative300.bin", "Word2vec file with pre-trained embeddings")
...
def train():
    ...
    print("Train/Dev split: {:d}/{:d}/n".format(len(y_train), len(y_dev)))
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            if FLAGS.word2vec:
                ...
                print("Success to load pre-trained word2vec model!/n")
            ...
            for batch in batches:
                ...
                if step % FLAGS.evaluate_every == 0:
                    ...
                    time_str = datetime.datetime.now().isoformat()
                    print("{}: step {}, loss {:g}, acc {:g}/n".format(time_str, step, loss, accuracy))
