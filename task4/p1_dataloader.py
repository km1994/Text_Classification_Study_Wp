...
if __name__ == "__main__":
    ...
    train_docs_list = jieba_cut_word(train_list,stopword_path,cut_word_to_str_flag = False)
    test_docs_list = jieba_cut_word(test_list, stopword_path, cut_word_to_str_flag=False)

    del train_file_path, train_list, test_file_path, test_list, stopword_path

    # print("docs_list[0:2]:{0}".format(docs_list[0:2]))

    cut_words_train_filename = "../resource/THUCNews_ch/t1_cut_words_cnews.train.txt"
    write_file(cut_words_train_filename, train_docs_list, train_labels, is_num=False)

    cut_words_test_filename = "../resource/THUCNews_ch/t1_cut_words_cnews.test.txt"
    write_file(cut_words_test_filename, test_docs_list, test_labels, is_num=False)
