...
if __name__ == "__main__":
    ...
    onehot_gs = createNB(onehot_train_list, onehot_train_labels)
    test_NB(onehot_gs, onehot_test_list, onehot_test_labels)
    print("--------------------One-HOT NB-----------------------")
    '''
        output:
                  (1000,) (1000,) (1000, 1000)
    ...
    tfidf_gs = createNB(tfidf_train_list, tfidf_train_labels)
    test_NB(tfidf_gs, tfidf_test_list, tfidf_test_labels)

    print("--------------------mutual_info NB-----------------------")
    # 文件读取
    ...
    mutual_info_gs = createNB(mutual_info_train_list, mutual_info_train_labels)
    test_NB(mutual_info_gs, mutual_info_test_list, mutual_info_test_labels)
