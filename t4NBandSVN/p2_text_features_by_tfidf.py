...
if __name__ == "__main__":
    ...
    feature_dict_filename = "../resource/THUCNews_ch/t2_feature_words_tfidf_cnews.txt"
    write_feature_dict_file(feature_dict_filename, feature_words)

    train_feature_filename = "../resource/THUCNews_ch/t2_text_feature_tfidf_cnews.train.txt"
    ...
    test_feature_filename = "../resource/THUCNews_ch/t2_text_feature_tfidf_cnews.test.txt"
    ...
    del train_file_path,train_list, train_labels,test_file_path,test_list, test_labels,deleteN,train_feature_list, test_feature_list
    del feature_words,feature_dict_filename, test_feature_filename, train_feature_filename
